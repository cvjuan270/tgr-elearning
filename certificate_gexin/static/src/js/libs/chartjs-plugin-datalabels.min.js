...
!(function (t, e) {
    ...
    function d(t, e) {
        ...
        return (
            e.clamp &&
                (o = (function (t, e) {
                    for (
                        var r, n, i, o = t.x0, d = t.y0, c = t.x1, h = t.y1, x = f(o, d, e), y = f(c, h, e);
                        x | y && !(x & y);
    ...
    function v(t, e, r) {
        ...
        i && t.strokeText(e, o, a, l),
            r.filled && (n && i && (t.shadowBlur = 0), t.fillText(e, o, a, l), n && i && (t.shadowBlur = n));
    }
    ...
    h.extend(_.prototype, {
        ...
        draw: function (t, e) {
            ...
            this.visible() &&
                (i.save(),
                o.clip &&
                    ((r = o.area), i.beginPath(), i.rect(r.left, r.top, r.right - r.left, r.bottom - r.top), i.clip()),
                        ...
                        for (
                            r = (function (t, e, r) {
                                var n = r.lineHeight,
                                    ...
                                    o = t.x;
                                return (
                                    "center" === e ? (o += i / 2) : ("end" !== e && "right" !== e) || (o += i),
