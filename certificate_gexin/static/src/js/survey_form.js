odoo.define("survey.form", function (require) {
    ...
    publicWidget.registry.SurveyFormWidget = publicWidget.Widget.extend(
        SurveyPreloadImageMixin,
        {
                    ...
                    if ($matrixBtn.length > 0) {
                        ...
                        if (this.options.questionsLayout !== "page_per_question") {
                            ...
                            if (
                                ...
                                ).includes(previouslySelectedAnswer.find("input").val())
                            ) {
            ...
            _validateForm: function ($form, formData) {
                ...
                $form.find("[data-question-type]").each(function () {
                    ...
                    switch ($input.data("questionType")) {
                        ...
                        case "matrix":
                            if (questionRequired) {
                                var subQuestionsIds = $questionWrapper
                                    .find("table")
                                    .data("subQuestions");
                                subQuestionsIds.forEach(function (id) {
             ...
             */
            _prepareSubmitAnswerMatrix: function (
                params,
                questionId,
                rowId,
                colId,
            ...
            _initBreadcrumb: function () {
                ...
                if ($breadcrumb.length) {
                    this.surveyBreadcrumbWidget =
                        new publicWidget.registry.SurveyBreadcrumbWidget(this, {
            ...
            _initTimer: function () {
                ...
                var questionTimeLimitReached = $timerData.data(
            ...
            _getInactiveConditionalQuestionIds: function () {
                ...
                if (this.options.triggeredQuestionsByAnswer) {
                    Object.keys(this.options.triggeredQuestionsByAnswer).forEach(
                        function (answerId) {
                            if (!self.selectedAnswers.includes(parseInt(answerId))) {
                                self.options.triggeredQuestionsByAnswer[
                                    answerId
                                ].forEach(function (questionId) {
